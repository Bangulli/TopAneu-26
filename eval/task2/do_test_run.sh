...
# of test_evaluations/ground-truth to GT_DIR with a location_masks subdir
# (for load_gt() from evaluate.py to work inside docker env)
GT_DIR="${SCRIPT_DIR}/test_evaluations/docker-ground-truth"
mkdir -pv "$GT_DIR/location_masks"
cp -avr "${SCRIPT_DIR}/test_evaluations/ground-truth/"* "$GT_DIR/location_masks/"
